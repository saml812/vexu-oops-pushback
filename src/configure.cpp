...
pros::v5::MotorGroup leftDrive({-16, 17, -18, 19, -20}, pros::v5::MotorGears::blue, pros::v5::MotorUnits::deg);
pros::v5::MotorGroup rightDrive({11, -12, 13, -14, 15}, pros::v5::MotorGears::blue, pros::v5::MotorUnits::deg);
// 11-15

pros::v5::Motor leftIntake(10, pros::v5::MotorGears::blue, pros::v5::MotorUnits::deg);
pros::v5::Motor rightIntake(-2, pros::v5::MotorGears::blue, pros::v5::MotorUnits::deg);
// pros::v5::Motor leftLever(9, pros::v5::MotorGears::green, pros::v5::MotorUnits::deg);
// pros::v5::Motor rightLever(-1, pros::v5::MotorGears::green, pros::v5::MotorUnits::deg);

// pros::v5::MotorGroup intake({10, -2}, pros::v5::MotorGears::blue, pros::v5::MotorUnits::deg);
pros::v5::MotorGroup lever({9,-1}, pros::v5::MotorGears::green, pros::v5::MotorUnits::deg);
...
lemlib::ControllerSettings turnController(
    5,
    0,
    45,
    3,
...
lemlib::Chassis chassis(drivetrain, linearController, turnController, sensors, &throttleCurve, &steerCurve);
