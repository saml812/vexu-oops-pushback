...
void skills2() {
  ...
  chassis.pid_odom_set({{-62_in, 47_in}, fwd, DRIVE_SPEED});
  // Intake

  chassis.pid_turn_set({-27_in, 47_in}, fwd, 90);
  chassis.pid_odom_set({{-27_in, 47_in}, fwd, DRIVE_SPEED});
  // Outtake

  chassis.pid_odom_set({{-47_in, 47_in}, rev, DRIVE_SPEED});
  chassis.pid_turn_set({-47_in, 64_in}, fwd, 90);
  chassis.pid_odom_set({{-47_in, 64_in}, fwd, DRIVE_SPEED});
  // Intake

  chassis.pid_odom_set({{-47_in, 47_in}, rev, DRIVE_SPEED});
  chassis.pid_turn_set({-56_in, 12_in}, fwd, 90);

  chassis.pid_odom_set({{-56_in, 12_in, 180_deg}, fwd, DRIVE_SPEED});
  // Intake

  chassis.pid_odom_set({{-56_in, -13_in, 180_deg}, fwd, DRIVE_SPEED});
  chassis.pid_odom_set({{-38_in, -35_in, 135_deg}, fwd, DRIVE_SPEED});
  chassis.pid_turn_set({0_in, 0_in}, fwd, 45);
  chassis.pid_odom_set({{-7.5_in, -7.5_in, 135_deg}, fwd, DRIVE_SPEED});
  // Outtake (Score Middle Goal Low)

  chassis.pid_odom_set({{-46.814_in, -46.5_in}, rev, DRIVE_SPEED});
  chassis.pid_turn_set({-47_in, 69_in}, fwd, 90);
  chassis.pid_odom_set({{-47_in, -63.247_in}, fwd, DRIVE_SPEED});
  // Intake

  chassis.pid_odom_set({{-46.814_in, -46.5_in}, rev, DRIVE_SPEED});
  chassis.pid_turn_set({-67.5_in, -46.5_in}, fwd, 90);
  chassis.pid_odom_set({{-63.288_in, -47.237_in}, fwd, DRIVE_SPEED});
  // Intake

  chassis.pid_odom_set({{-46.814_in, -46.5_in}, rev, DRIVE_SPEED});
  chassis.pid_turn_set({-27.5_in, -46.5_in}, fwd, 90);
  chassis.pid_odom_set({{-27.5_in, -46.5_in}, fwd, DRIVE_SPEED});
  // Outtake (Score Bottom Goal)
